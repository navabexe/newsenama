...
class Settings(BaseSettings):
    ...
    # CSRF settings
    CSRF_TOKEN_SECRET: str = Field(..., description="Secret key for generating CSRF tokens")
    CSRF_TOKEN_EXPIRY: int = Field(3600, description="CSRF token expiry time in seconds")
